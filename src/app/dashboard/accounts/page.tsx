...
function PlatformCard({
    ...
    const handleSaveProxy = async () => {
        ...
        try {
            ...
            setProxyMessage({ type: 'success', text: proxyInput.trim() ? 'Proxy saved.' : 'Proxy cleared.' });
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                {/* Action button */}
                <button
                    onClick={() => { onToggleAdd(isOpen ? null : platform.id); }}
                    style={{
            ...
            {isOpen && (
                <div style={{ padding: 20 }}>
                    <div style={{
                        ...
                        <svg viewBox="0 0 24 24" fill="none" stroke="var(--accent)" strokeWidth={2} width={18} height={18} style={{ flexShrink: 0, marginTop: 1 }}>
                            <circle cx="12" cy="12" r="10" />
                            <line x1="12" y1="8" x2="12" y2="12" />
                            <line x1="12" y1="16" x2="12.01" y2="16" />
                        </svg>
                        <div style={{ fontSize: 13, color: 'var(--text-secondary)', lineHeight: 1.6 }}>
                            <strong style={{ color: 'var(--text-primary)' }}>Connect with the GetMention extension</strong>
                            <br />
                            Install the extension in Chrome, log into your {platform.label} account in your browser,
                            and the extension will use your live session to engage automatically — no cookies to copy or paste.
                        </div>
                    </div>
                </div>
            )}
    ...
    return (
        <div className="animate-fade-in">
            ...
            <div className="page-body" style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                ...
                {/* Extension download banner — always shown at the top */}
                <ExtensionInstallCard theme="dark" />
